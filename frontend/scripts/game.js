...
// Game objects
const paddle1 = { x: 10, y: HEIGHT / 2 - PADDLE_HEIGHT / 2, width: PADDLE_WIDTH, height: PADDLE_HEIGHT };
const paddle2 = { x: WIDTH - PADDLE_WIDTH - 10, y: HEIGHT / 2 - PADDLE_HEIGHT / 2, width: PADDLE_WIDTH, height: PADDLE_HEIGHT };
const ball = { x: WIDTH / 2 - BALL_SIZE / 2, y: HEIGHT / 2 - BALL_SIZE / 2, size: BALL_SIZE };
...
function movePaddles() {
  ...
  if (keys.ArrowDown && paddle2.y < HEIGHT - PADDLE_HEIGHT) paddle2.y += PADDLE_SPEED;
}
